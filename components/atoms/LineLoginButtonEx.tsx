...
export const LineLoginButton = ({
  ...
  return (
    <button
      disabled={disabled}
      className={clsx(
        "relative flex items-center justify-center px-4 py-2 rounded-lg font-medium transition-all overflow-hidden select-none gap-2 w-64",
        disabled
    ...
    >
      ...
      <span
        className={clsx(
          "absolute left-10 top-1/2 -translate-y-1/2 h-[100%] w-px",
      ...
      <Image
        ...
        width={24}
        height={24}
        className="relative z-10 left-[-6]"
      />
